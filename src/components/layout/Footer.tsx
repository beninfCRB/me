...
function BackToTop() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-6 z-40 grid h-12 w-12 place-items-center rounded-full bg-gradient-to-br from-primary to-fuchsia-500 text-white shadow-glow transition-transform duration-500 ease-silk hover:scale-110"
    >
          ...
          <div className="flex flex-col items-center gap-4">
            <button
              ...
              className={cn(
                ...
                "bg-gradient-to-r from-primary via-fuchsia-500 to-cyan-400 bg-clip-text text-transparent",
