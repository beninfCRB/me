...
export const experiences: Experience[] = [
  {
    ...
    period: "2025 - 2026",
    description: "Developing core public applications and microservice ERP modules for environmental fund management.",
    achievements: [
  ...
  },
  {
    ...
    period: "2022 - 2025",
    description: "Leading development and enhancement of cargo ERP applications and supporting systems.",
    achievements: [
  ...
  },
  {
    ...
    period: "2022 - 2022",
    description: "Providing technical repair services for computer and mobile devices.",
    achievements: [
  ...
  },
  {
    ...
    period: "2019 - 2021",
    description: "Supporting laboratory operations and assisting students in practical learning.",
    achievements: [
      "Assisting lecturers and students in practical learning",
...
export const education: Education[] = [
  {
    ...
    period: "2025 - Present",
    description: "Specializing in Digital Transformation Intelligence. Studies focus on enterprise architecture design, digital transformation strategies, and the use of Business Intelligence to support data-driven decision-making at the managerial level.",
  },
  {
    id: "2",
    ...
    period: "2017 - 2021",
    description: "Graduated with a GPA of 3.89/4.00. Served as a Computer Laboratory Assistant, honing technical skills in managing IT infrastructure, troubleshooting hardware and software issues, and guiding students through complex practical sessions.",
  },
]
...
export const projects: Project[] = [
  {
    id: "1",
    title: "Zero Carbon ERP System",
    description: "Core public application for Community Environmental Funds to drive the Zero Carbon by 2030 initiative, featuring microservice architecture and real-time data analytics.",
    technologies: ["React", "Nest JS", "Docker", "PostgreSQL", "Microservices"],
    github: "https://github.com/beni-nurfauzi",
    link: "#",
  },
  {
    id: "2",
    title: "Cargo ERP Platform",
    description: "Large-scale cargo ERP application with 18 microservice modules for efficient logistics management and fund distribution.",
  ...
  {
    id: "3",
    title: "Environmental Fund Management",
    description: "Internal data management system for environmental fund distribution with role-based access control and audit trails.",
  ...
  },
  {
    ...
    description: "Business Intelligence dashboard for data-driven decision-making with real-time visualization and predictive analytics.",
    technologies: ["React", "Adonis JS", "PostgreSQL", "Chart.js"],
    github: "https://github.com/beni-nurfauzi",
    link: "#",
  },
]
...
export const techLogos = [
  "React", "Next.js", "TypeScript", "Nest.js", "Express.js",
  "Adonis.js", "Laravel", "Docker", "Git", "PostgreSQL",
  "Tailwind CSS", "React Native", "Codeigniter", "Redis", "Microservices",
]