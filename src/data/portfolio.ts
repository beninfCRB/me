...
export const projects: Project[] = [
  {
    ...
    description: "Public application for Community Environmental Funds to drive the Zero Carbon by 2030 initiative, featuring microservice architecture and real-time data analytics.",
  ...
  },
  {
    id: "3",
    title: "MIS BPDLH",
    description: "Internal ERP application for environmental fund management with role-based access control and audit trails.",
  ...
  },
  {
    ...
    description: "Personal portfolio website showcasing skills, experience, and projects with modern UI/UX.",
